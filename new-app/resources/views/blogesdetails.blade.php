...
@section('title')
    <p style="font-size: larger; color: #2d3748;">Blog Details</p>
    <h1 style="text-align: center; font-size: larger; color: cornflowerblue;">
        This Page View Details About Each Technology
    </h1>
@endsection
