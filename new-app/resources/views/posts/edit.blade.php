...
{{--                        <label for="category_id" class="formbold-form-label">Category</label>--}}
                ...
                <div class="formbold-input-flex">
                    <div>
                        <input type="text" name="price" id="price" value="{{ old('price', $post->price) }}" class="formbold-form-input"/>
                        @error('price')
                ...
                <div class="formbold-textarea">
                    <textarea rows="6" name="description" id="description" class="formbold-form-input">
